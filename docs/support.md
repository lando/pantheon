...
description: Get help with and support for the Lando Pantheon recipe.
---
...
If you have a question or would like some community support we recommend you [join the Lando community on Slack](https://launchpass.com/devwithlando). It's also probably a good idea to join the [Pantheon one](https://slackin.pantheon.io/) as well.
