...
**Note that you will need to replace (or export) `$PANTHEON_MACHINE_TOKEN_3` and `--pantheon-site` to values that make sense for you.**
...
lando init --source pantheon --pantheon-auth "$PANTHEON_MACHINE_TOKEN_3" --pantheon-site landobot-drupal9
