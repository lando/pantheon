...
exports.DEFAULT_PHP_VERSION = DEFAULT_PHP_VERSION;
      ...
      services: {
        index: {
          ...
          overrides: {
            ...
            volumes: [
              `${options.confDest}/jetty.xml:/opt/solr/server/etc/jetty.xml`,
            ],
          },
        },
      },
    };
  } else if (searchVersion === '9') {
    return {
      services: {
        index: {
          type: 'pantheon-solr:9',
          portforward: true,
          core: 'lando',
          overrides: {
            image: `devwithlando/pantheon-index:${options.solrTag}`,
            volumes: [
              `${options.confDest}/jetty-solr9.xml:/opt/solr/server/etc/jetty.xml`,
            ],
          },
        },
      },
